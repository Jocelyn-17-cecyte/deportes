...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <span class="navbar-brand mb-0 h1">VDeportenis </span>
    </nav>
    ...
    <main class="container mt-5">
        ...
        <p class="text-justify">
            Esta es una plantilla sencilla que incluye un encabezado con un banner, un cuerpo centralizado y un pie de página básico.
            Puedes personalizarla según tus necesidades agregando más estilos y contenido.
        </p>
        
        <!-- Banner -->
        <div class="mt-4">
            <img src="img/nature.png" alt="Banner" class="img-fluid w-100">
        </div>
    </main>
    <br>
